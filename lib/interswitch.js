 ...
 */
//prototype sendv2
Interswitch.prototype.sendv2 = function(options, callback){
...
Interswitch.prototype.sendWithAccessToken = function(options, callback) {
     ...
     * @memberOf Interswitch
     */
Interswitch.prototype.getAuthData = function(pan, expDate, cvv, pinString, publicModulus, publicExponent) {
        //TODO : validation
    ...
    */
Interswitch.prototype.getSecureData = function(pan, expDate, cvv, pin, amount, mobile, ttId, publicModulus, publicExponent){
